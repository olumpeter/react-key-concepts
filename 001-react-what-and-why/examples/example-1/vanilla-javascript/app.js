...
function closeModal() {
    ...
    emailInputElement.addEventListener("blur", validateInputHandler.bind(null, "email"));
    passwordInputElement.addEventListener("blur", validateInputHandler.bind(null, "password"));
}
